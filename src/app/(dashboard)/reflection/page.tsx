  ...
  return (
    <div className="w-full mx-auto">
      ...
      <section>
        ...
        <div className="bg-gray-50 dark:bg-[#1F2937] backdrop-blur-sm rounded-xl p-6 mb-8">
          <div className="flex items-center gap-3 mb-3">
            <span className="text-xl">⚠️</span>
            <p className="font-medium text-gray-800 dark:text-yellow-50">
          ...
          <div className="bg-blue-50 dark:bg-blue-950/30 rounded-lg p-4 pl-9 text-sm">
  ...
  return (
    <div
      className={`rounded-xl p-5 backdrop-blur-sm
        ${
          bgColor === 'bg-[#3E2A1B]'
            ? 'bg-amber-50 dark:bg-[#3E2A1B]'
            : bgColor === 'bg-[#1E2A3B]'
            ? 'bg-blue-50 dark:bg-[#1E2A3B]'
            : bgColor === 'bg-[#1F1B2E]'
            ? 'bg-purple-50 dark:bg-[#1F1B2E]'
            : 'bg-gray-50 dark:bg-[#1F2937]'
        }`}
    >
      <div className="flex items-center gap-3 mb-3">
        {icon && <span className="text-xl">{icon}</span>}
        <h2 className="font-medium text-gray-800 dark:text-yellow-50">
          {question}
        </h2>
      </div>
      <p className="text-gray-600 dark:text-gray-400 pl-9">{answer}</p>
    </div>
  );
}
